...
function PetSafetyMap() {
  return (
    <div className="pet-map" aria-label="نقشه محدوده امن حیوانات">
      ...
      <div className="safe-zone"><span>محدوده امن خانه</span></div>
      <div className="home-marker" title="خانه"><House aria-hidden="true" size={18} /></div>
      <div className="pet-marker liam-marker"><span><PawPrint aria-hidden="true" size={17} /></span><b>لیام</b><small>داخل محدوده</small></div>
      <div className="pet-marker ninoosh-marker"><span><PawPrint aria-hidden="true" size={17} /></span><b>نینوش</b><small><BellRing aria-hidden="true" size={12} /> خارج از محدوده، ارسال هشدار</small></div>
    </div>
  );
}
  ...
  return (
    <main id="top">
      ...
      <div className="section-nav-wrap">
        <nav className="section-nav shell" aria-label="دسترسی سریع به بخش‌های صفحه">
      ...
      <section className="problem shell section" id="platform">
        ...
        <div className="problem-grid">
          ...
          <div className="before-after">
            ...
            <span className="transform"><ArrowLeft aria-hidden="true" size={26} /></span>
      ...
      <section className="solutions section shell" id="solutions">
        ...
        <div className="solution-grid">
          ...
          <article className="solution-card pet-solution"><div className="card-top"><span className="icon-box"><Icon name="pet" /></span><small>Pet Tech</small></div><h3>ردیاب و خدمات حیوانات</h3><p>مسیر محصولی در مرحله طراحی برای ردیاب حیوانات خانگی و شهری؛ شامل موقعیت، محدوده امن، پروفایل حیوان و سرویس‌های مشارکتی مبتنی بر مکان.</p><ul><li>موقعیت و محدوده امن</li><li>پروفایل حیوان</li><li>شبکه مراقبان</li><li>API برای شرکا</li></ul><div className="card-art pet-art"><PetSafetyMap /></div></article>
      ...
      <section className="architecture section" id="architecture">
        <div className="shell">
          ...
          <div className="layer-stack">
            ...
            <div className="flow"><ArrowUp aria-hidden="true" size={14} /><span>Protocol adapters & connectors</span></div>
...
{'}'}</code></pre><div className="terminal-result"><span>DESIGN PREVIEW</span><b>نمونه‌ی جهت‌گیری قرارداد؛ نه API منتشرشده</b></div></div>
      ...
      <footer className="footer shell"><Logo/><p>زیرساخت اتصال و یکپارچه‌سازی محصولات هوشمند</p><div><a href="https://github.com/CoreLinkPlatform">GitHub</a><a href="#developers">Developers</a><a href="#top">بازگشت به بالا <ArrowUp aria-hidden="true" size={13} /></a></div><small>© 2026 CoreLink Platform</small></footer>
    </main>
  );
}
